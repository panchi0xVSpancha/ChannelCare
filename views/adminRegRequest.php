        ...
        <div class="wrapper">
            ...
            <div class="content">
                <div class="search">
                    ...
                    <button onclick="window.location='adminRegRequest.php';" type="button">Show All</button>
                    <div class="search-bar">
                        <form action="adminRegRequest.php" method="post">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a style="color: red; cursor: pointer;"
                                            onclick='popBlock(<?php echo $row["doctor_id"]; ?>,"<?php echo $row["email"]; ?>","<?php echo $row["type"]; ?>");'>Deny</a>
