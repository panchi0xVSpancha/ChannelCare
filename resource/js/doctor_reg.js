...
$('#doctorReg').on('submit',function(){
    ...
    $.ajax({
        ...
        method:"POST",
        data:{saveDoctor:"saveDoctor",first_name:first,last_name:last,address:address,phone_number:phone,email:email,level:level,password:password,confirmpassword:confirmpassword ,specialization: specialization,license:license,diploma:diploma},
        dataType:"json",
