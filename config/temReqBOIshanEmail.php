...
session_start();
     ...
     function senttemBOAccept($student_email,$city)
     {
...
<body>
    <div class="container">
        ...
        <div class="header">
            <h2>Bodima </h2>
            <h4>Hi '.$first_name.'</h4>
            <h3>Your order Request is accepted </h3>
        </div>
        </div>
        <div class="content">
           <div class="para"> <p>.
     ...
     function senttemBOReject($student_email)
     {
      $first_name=$_SESSION['first_name'];
...
<body>
    <div class="container">
     ...
     ////add boarder
      function sentCDAccept($student_email,$city)
     {
      $first_name=$_SESSION['first_name'];
         $subject="Message from Boadima.lk Website";
         $headers  = 'MIME-Version: 1.0' . "\r\n";
...
<body>
    <div class="container">
        ...
        <div class="header">
            <h2>Bodima </h2>
            <h4>Hi '.$first_name.'</h4>
            <h3>Hello welcome to my new Boarding place</h3>
        </div>
        </div>
        <div class="content">
           <div class="para"> <p>.
