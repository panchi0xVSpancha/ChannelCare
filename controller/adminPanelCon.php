...
if (isset($_GET['doctorRequestAccept_id'])) {
    ...
    $result = adminModel::confirmDoctorRegistration($request_id, $connection);
    if ($result) {
        header('Location:../views/adminDoctorPendingRequest.php');
    }
...
if (isset($_GET['doctorRequestCancel_id'])) {
    ...
    $result = adminModel::rejectDoctorRegistration($request_id,$connection);
    if ($result) {
        header('Location:../views/adminDoctorPendingRequest.php');
    }
...
if (isset($_POST['block'])) {
    ...
    if ($type == 'student') {
        header('Location:../views/adminStudent.php');
    }
    if ($type == 'boarder') {
        header('Location:../views/adminBorder.php');
    }
    if ($type == 'boardings_owner') {
        header('Location:../views/adminBoardingOwner.php');
    }
    if ($type == 'food_supplier') {
        header('Location:../views/adminFoodSupplier.php');
    }
}
